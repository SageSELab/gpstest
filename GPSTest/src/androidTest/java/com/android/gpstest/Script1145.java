...
public class Script1145 {
    ...
    public void testChangeText_sameActivity() {
        ...
        mDevice.click(75,700);

//        close = mDevice.wait(Until.findObject(By.res("android", "button2")),2000);
//        close.click();
//
//        UiObject2 lat = mDevice.wait(Until.findObject(By.res(BASIC_SAMPLE_PACKAGE, "ground_truth_lat_text")),2000);
//        lat.click();
        ...
        mDevice.click(75,500);

        mDevice.pressKeyCode(69);
    }
